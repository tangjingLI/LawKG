  ...
  <div style="position:relative;">
    ...
    <div class="chat-wrapper">
      <div class="chat-main" v-drag>
        ...
        <div>
          <el-row>
            <el-button plain @click="chooseCategory(1)">罪名预测</el-button>
            <el-button plain @click="chooseCategory(2)">问题分类</el-button>
            <el-button plain @click="chooseCategory(3)">罪名查询</el-button>
          </el-row>
        </div>
        ...
        ></textarea>
          <div class="chat-input-tools">
            ...
            <button class="chat-button" style="margin-left: 20px" @click="closeChat">关闭</button>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      createInfo(name, value) {
        ...
        var nodeSpan = this.d.createElement('span');
